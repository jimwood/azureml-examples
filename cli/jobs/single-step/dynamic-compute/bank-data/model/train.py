...
def main(args):
    ...
    cpu_cluster_name = f"sptest-{vm_size}-{max_nodes}".replace("_", "-")
...
def parse_args():
    ...
    parser.add_argument("--service-principal-id", default=os.environ.get("SERVICE_PRINCIPAL_ID"), dest='service_principal_id',
                        type=str)
    parser.add_argument("--service-principal-password", default=os.environ.get("SERVICE_PRINCIPAL_PASSWORD"), dest='service_principal_password',
                        type=str)
    parser.add_argument("--subscription-id", default=os.environ.get("SUBSCRIPTION_ID"), dest='subscription_id',
                        type=str)
    parser.add_argument("--resource-group", default=os.environ.get("RESOURCE_GROUP_NAME"), dest='resource_group',
                        type=str)
    parser.add_argument("--workspace-name", default=os.environ.get("WORKSPACE_NAME"), dest='workspace_name',
                        type=str)
    parser.add_argument("--tenant-id", default=os.environ.get("TENANT_ID"), dest='tenant_id',
                        type=str)
    # parse args
